...
AddonTitle="[COLOR ghostwhite]Instant Tools[/COLOR]"
thumbnailPath = xbmc.translatePath('special://userdata/Thumbnails');
cachePath = os.path.join(xbmc.translatePath('special://home'), 'cache')
tempPath = xbmc.translatePath('special://temp')
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'plugin.video.instanttrialiptv2')
ICON = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.instanttrialiptv2', 'icon.png'))
