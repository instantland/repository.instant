...
import maintenance
AddonID = 'plugin.video.instanttrialiptv2'
...
FabAddon = xbmcaddon.Addon('plugin.video.instanttrialiptv2')
ADDON=xbmcaddon.Addon(id='plugin.video.instanttrialiptv2')
dialog       =  xbmcgui.Dialog()
dialogprocess =  xbmcgui.DialogProgress()
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/',''))
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.instanttrialiptv2/',''))
HOME         =  xbmc.translatePath('special://home/')
Username=plugintools.get_setting("Username")
Password=plugintools.get_setting("Password")
PVRon = plugintools.get_setting("PVRUpdater")
lehekylg= base64.b64decode("aHR0cDovL2RtdG4tdHYuY29t") #####
pordinumber="8080"
