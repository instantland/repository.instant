...
import maintenance
AddonID = 'plugin.video.instanttrialiptv1'
AddonTitle = 'INSTANT IPTV'
Images=xbmc.translatePath(os.path.join('special://home','addons',AddonID,'resources/art/'));
fanart = Images+'fanart.jpg'
icon = Images+'icon.png'
FabAddon = xbmcaddon.Addon('plugin.video.instanttrialiptv1')
ADDON=xbmcaddon.Addon(id='plugin.video.instanttrialiptv1')
dialog       =  xbmcgui.Dialog()
dialogprocess =  xbmcgui.DialogProgress()
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/',''))
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.instanttrialiptv1/',''))
HOME         =  xbmc.translatePath('special://home/')
Username=plugintools.get_setting("Username")
Password=plugintools.get_setting("Password")
PVRon = plugintools.get_setting("PVRUpdater")
lehekylg= base64.b64decode("aHR0cDovL3VuaWNhc3R2LnRvcA==") #####
pordinumber="8080"
